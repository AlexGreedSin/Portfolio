    ...
    <div className={styles.pageContainer}>
      ...
      <div className={styles.centeredContent}>
        <Head>
          ...
          <title>
            Alexandre Bailey-Proulx&apos;s Portfolio - {language === 'english' ? 'Systeme Caisse' : 'Système Caisse'}
          </title>
          <meta
            name="description"
            content={
              language === 'english'
                ? "Cash register software for calculating purchases of a fictional company."
                : "Logiciel de caisse pour calculer les achats d'une compagnie fictive."
            }
          />
          <meta property="og:title" content={`Alexandre Bailey-Proulx's Portfolio - ${language === 'english' ? 'Systeme Caisse' : 'Système Caisse'}`} />
          <meta
        ...
        {/* Title */}
        <h1 className={styles.titre}>{language === 'english' ? 'Systeme Caisse' : 'Système Caisse'}</h1>
        {/* First Image */}
