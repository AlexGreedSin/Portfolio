  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <div className={styles.centeredContent}>
        <Head>
          <title>Alexandre Bailey-Proulx&apos;s Portfolio - Space Survivor</title>
          <meta name="description" content={language === 'english' ? "Space Survivor video game created using GameMaker software. Objective: survive the asteroids." : "Jeu vidéo Space Survivor sur le logiciel GameMaker. Objectif : survivre aux astéroïdes."} />
          <meta property="og:title" content="Alexandre Bailey-Proulx's Portfolio - Space Survivor" />
          <meta property="og:description" content={language === 'english' ? "Space Survivor video game created using GameMaker software. Objective: survive the asteroids." : "Jeu vidéo Space Survivor sur le logiciel GameMaker. Objectif : survivre aux astéroïdes."} />
